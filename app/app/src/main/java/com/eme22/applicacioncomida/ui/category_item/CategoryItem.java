...
public class CategoryItem extends Fragment {
    ...
    private CategoryItem(String title) {
        this.title = title;
    }

    public static CategoryItem newInstance(String title) {
        return new CategoryItem(title);
    }
    ...
    private void initView() {
        ...
        binding.categoryItemFragmentToolbar.setTitle(title);
    ...
    private void buyItem(Item cartItem) {
        ...
        fTransaction.add(R.id.main_fragment, BuyFragment.newInstance(cartItem), "BuyItem");
        fTransaction.commit();
    }
