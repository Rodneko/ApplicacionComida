...
public class HomeViewModel extends ViewModel {
    ...
    LiveData<Category> getSelectedCategory() {
    ...
    public void retrieveItem(long id) {
        service.getItem(Math.toIntExact(id)).enqueue(new Callback<Item>() {
            @Override
    ...
    public void retrieveCategory(long id) {
        service.getCategory(Math.toIntExact(id)).enqueue(new Callback<Category>() {
            @Override
