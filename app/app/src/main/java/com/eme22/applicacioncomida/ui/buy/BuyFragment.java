...
public class BuyFragment extends Fragment {
    ...
    private CartViewModel helperViewModel;

    private FragmentBuyBinding binding;

    private final Item categoryItem;

    private BuyFragment(Item categoryItem) {
        this.categoryItem = categoryItem;
    }

    public static BuyFragment newInstance(Item item) {
        return new BuyFragment(item);
    }
    ...
    private void initView(){
        ...
        helperViewModel = new ViewModelProvider(requireActivity()).get(CartViewModel.class);
    ...
    private void addToCartCurrent() {
        helperViewModel.addItem(new CartItem(0, null, 0, mViewModel.getCurrent().getValue().getId(), mViewModel.getCurrent().getValue(),mViewModel.getCount().getValue()), ((MainActivity) requireActivity()).getUser());
    ...
    private void initData() {
        ...
        mViewModel.setCurrent(categoryItem);
